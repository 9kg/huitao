...
const cfg = (() => {
    ...
    return {
        ...
        less_to: _dev + '/css',
        concat_src: [_src + 'js/zepto.js', _src + 'js/base.js', _src + 'js/data_module.js', _src + 'js/sm.js', _src + 'js/sm-extend.js', _src + 'js/html_temp.js', _src + 'js/event.js', _src + 'js/init.js', _src + 'js/page/*.js'],
        concat_src2build: [_src + 'js/zepto.js', _src + 'js/base.js', _src + 'js/sm.js', _src + 'js/sm-extend.js', _src + 'js/html_temp.js', _src + 'js/event.js', _src + 'js/init.js', _src + 'js/page/*.js'],
        concat_to: _dev + '/js',
